...
def test_handle():
    ...
    response = register_cliente_controller.handle_insert(http_request)
...
def test_select_controller():
    ...
    response = register_cliente_controller.handle_select(http_request)
...
def test_select_all_controller():
    ...
    http_request = HttpRequest()
    response = register_cliente_controller.handle_select_all(http_request)
...
def test_delete_controller():
    ...
    response = register_cliente_controller.handle_delete(http_request)
...
def test_handle_update():
    ...
    response = register_cliente_controller.handle_update(http_request)
